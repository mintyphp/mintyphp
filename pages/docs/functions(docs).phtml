<h1>Functions</h1>
<p>The two "shortcut" functions "d()" and "e()" can be used anywhere in your application.</p>
<h2>Escaped echo</h2>
<pre>e($variable)</pre>
...
<h2>Debug</h2>
<pre>d($variable)</pre>
<p>The "d" (for debug) function logs the contents of a variable to the "Logging" panel of the debugger.
...
Hence, calling "d($variable)" is equal to calling "d($variable,100,25,10)".</p>