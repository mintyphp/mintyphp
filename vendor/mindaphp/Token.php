...
class Token {
	...
	protected static function getToken($headers) {
	...
	protected static function getVerifiedClaims($headers,$time,$leeway,$ttl,$algorithm,$secret) {
		$token = static::getToken($headers);
